...
export const metadata: Metadata = {
  ...
  description:
    "Discover our commitment to accessible tourism. Learn about our wheelchair-accessible vehicles, assistance services, and inclusive tour experiences.",
};
...
const accessibilityFeatures = [
  {
    ...
    description:
      "Our fleet includes wheelchair-accessible buses with hydraulic lifts and secure wheelchair spaces",
    details: [
  ...
  },
  {
    ...
    description:
      "Services and accommodations for guests with visual impairments",
    details: [
...
const tourAccessibility = [
  {
    ...
    notes:
      "Most stops are wheelchair accessible. Some heritage locations may have limited access.",
  },
  {
    category: "Day Tours",
    ...
    notes:
      "Accessibility varies by destination. We work to modify tours to meet individual needs.",
  },
  {
    category: "Wine Tours",
    ...
    notes:
      "Some wineries have limited accessibility. We select venues with best access options.",
  },
  {
    ...
    notes:
      "Requires advance planning. We work closely with guests to ensure suitable arrangements.",
  },
];
...
const bookingProcess = [
  {
    ...
    description:
      "Reach out at least 48 hours before your tour to discuss your specific needs",
  },
  {
    step: 2,
    title: "Needs Assessment",
    description:
      "Our team will discuss your requirements and available accommodations",
  },
  {
    step: 3,
    title: "Tour Customization",
    description:
      "We'll modify the tour itinerary and arrangements to meet your needs",
  },
  {
    step: 4,
    title: "Confirmation",
    description:
      "Receive detailed confirmation of all accessibility arrangements",
  },
];
...
const companionCard = {
  ...
  description:
    "We proudly accept the Companion Card, providing free travel for essential companions of people with disabilities.",
  benefits: [
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground font-text leading-relaxed">
              At Pineapple Tours, we believe that everyone deserves to
              experience the wonder of Queensland's attractions. We're committed
              to providing accessible tourism experiences that accommodate
              diverse needs and ensure all our guests can create lasting
              memories.
            </p>
          </div>
            ...
            {accessibilityFeatures.map((feature, index) => (
              ...
              >
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground mb-4 font-text">
                    {feature.description}
                  </p>
              ...
              <Card key={index} className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="flex justify-between items-start">
                    ...
                    <Badge
                      variant={
                        tour.accessibility === "High"
                          ? "default"
                          : tour.accessibility === "Moderate to High"
                          ? "secondary"
                          : "outline"
                      }
                      className={
                  ...
                  <TabsContent value="benefits" className="mt-6">
                    <ul className="space-y-3">
                      {companionCard.benefits.map((benefit, index) => (
                        <li
                          key={index}
                          className="flex items-center gap-3 font-text"
                        >
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground font-text max-w-2xl mx-auto">
              Follow these simple steps to ensure your accessibility needs are
              met
            </p>
          </div>
      ...
      <section className="py-16 bg-brand-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90 font-text max-w-2xl mx-auto">
            Our accessibility team is here to help you plan the perfect tour
            experience. Contact us to discuss your specific needs and
            requirements.
          </p>
