...
import { Utensils, AlertTriangle, Heart, Shield, Phone, Mail, CheckCircle } from "lucide-react"

export const metadata: Metadata = {
  title: "Allergies and Dietary Requirements | Pineapple Tours",
  description: "Learn about our allergy management and dietary accommodation policies. We're committed to ensuring safe and enjoyable tours for guests with special dietary needs.",
}
...
const safetyMeasures = [
  {
    ...
    description: "We discuss all dietary requirements and allergies during booking confirmation",
    icon: Phone
  },
  {
    title: "Venue Coordination",
    description: "We work directly with restaurants and venues to ensure proper meal preparation",
    icon: Utensils
  },
  {
    title: "Staff Training",
    description: "Our guides are trained in allergy awareness and emergency procedures",
    icon: Shield
  },
  {
    title: "Emergency Preparedness",
    description: "Guides carry emergency contact information and know nearest medical facilities",
    icon: Heart
  }
]
          ...
          <div className="container mx-auto px-4">
            <Alert className="max-w-4xl mx-auto border-red-200">
              ...
              <AlertDescription className="text-red-800 font-text">
                <strong>Important:</strong> Please inform us of all allergies and dietary requirements at the time of booking. 
                While we make every effort to accommodate special needs, we cannot guarantee a completely allergen-free environment. 
                Guests with severe allergies should carry appropriate medication and inform our guide before the tour begins.
              </AlertDescription>
            </Alert>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground font-text leading-relaxed">
                We understand that food allergies and dietary requirements are serious matters that can significantly impact 
                your tour experience. Our team is committed to working with you and our venue partners to ensure safe, 
                enjoyable meals throughout your journey.
              </p>
            </div>
              ...
              {safetyMeasures.map((measure, index) => (
                <Card key={index} className="text-center hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    ...
                    <h3 className="font-semibold mb-3 font-secondary">{measure.title}</h3>
                    <p className="text-sm text-muted-foreground font-text">{measure.description}</p>
                  </CardContent>
                </Card>
              ))}
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground font-text max-w-2xl mx-auto">
                We have experience managing these common food allergies and work with venues to ensure safe meal options
              </p>
            </div>
            
            <div className="grid md:grid-cols-4 gap-4 max-w-4xl mx-auto">
              {commonAllergies.map((allergy, index) => (
                <Card key={index} className={`text-center border-l-4 ${
                  allergy.color === 'red' ? 'border-l-red-500' :
                  allergy.color === 'yellow' ? 'border-l-yellow-500' :
                  'border-l-green-500'
                }`}>
                  <CardContent className="p-4">
                    <h3 className="font-semibold mb-2 font-secondary">{allergy.name}</h3>
                    <Badge 
                      variant={allergy.color === 'red' ? 'destructive' : allergy.color === 'yellow' ? 'default' : 'secondary'}
                      className="text-xs"
                    >
                      {allergy.severity}
                    </Badge>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground font-text max-w-2xl mx-auto">
                We work with venues to provide appropriate meal options for various dietary preferences and requirements
              </p>
            </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground font-text max-w-2xl mx-auto">
                Follow these steps to ensure your dietary needs are properly accommodated
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 font-secondary">At Booking</h3>
                <p className="text-sm text-muted-foreground font-text">
                  Mention all allergies and dietary requirements when making your reservation
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 font-secondary">Provide Details</h3>
                <p className="text-sm text-muted-foreground font-text">
                  Give specific information about severity, cross-contamination concerns, and safe alternatives
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 font-secondary">Confirmation Call</h3>
                <p className="text-sm text-muted-foreground font-text">
                  We'll call to confirm arrangements and discuss any venue limitations
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 font-secondary">Tour Day</h3>
                <p className="text-sm text-muted-foreground font-text">
                  Remind your guide of requirements and carry any necessary medication
                </p>
              </div>
            </div>
          </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <ul className="space-y-2 font-text">
                      ...
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-red-600 rounded-full mt-2 flex-shrink-0" />
                        Guests must carry their own emergency medication (EpiPens, etc.)
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="w-1.5 h-1.5 bg-red-600 rounded-full mt-2 flex-shrink-0" />
                        Final responsibility for food safety decisions rests with the guest
                      </li>
                    </ul>
                  </CardContent>
                </Card>
        ...
        <section className="py-16 bg-brand-primary text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 opacity-90 font-text max-w-2xl mx-auto">
              Contact our team to discuss your specific needs. We're here to help ensure you have a safe and enjoyable tour experience.
            </p>
