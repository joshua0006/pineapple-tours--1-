...
const contactInfo = [
  {
    icon: Phone,
    title: "Call Us",
    details: ["0466 331 232", "Available 24/7"],
  },
  {
    icon: Mail,
    title: "Email Us",
    details: ["bookings@pineappletours.com.au"],
  },
  {
    icon: Clock,
...
const faqs = [
  {
    ...
    answer:
      "We recommend booking at least 2-4 weeks in advance, especially during peak season (December-April). However, we often have last-minute availability for spontaneous participants.",
  },
  {
    question: "What's included in your tour packages?",
    answer:
      "Our packages typically include transportation, professional guides, entrance fees, and some meals. Specific inclusions vary by tour - check individual tour descriptions for details.",
  },
  {
    question: "Do you offer group discounts?",
    answer:
      "Yes! We offer special rates for groups of 8 or more. Contact us for a custom quote tailored to your group's needs and preferences.",
  },
  {
    question: "What's your cancellation policy?",
    answer:
      "We offer flexible cancellation policies. Most tours can be cancelled up to 48 hours before departure for a full refund. Some specialty tours may have different policies.",
  },
];
...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      <section className="py-20" style={{ backgroundColor: "#141312" }}>
      ...
      <section className="bg-white py-20">
        <div className="container max-w-4xl mx-auto px-4 text-center">
          ...
          >
            ...
            tropical getaway. Contact us today and let's make your dream
            vacation a reality!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              variant="outline"
              className="border-2 font-semibold transition-colors hover:bg-[#FF585D] hover:text-white hover:border-[#FF585D] bg-transparent text-white"
              style={{
                borderColor: "#FF585D",
                fontFamily: "Work Sans, sans-serif",
                fontWeight: 400,
