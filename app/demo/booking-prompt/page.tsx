...
export default function BookingPromptDemoPage() {
  ...
  const testDataTransfer = () => {
    ...
    // Store test data
    sessionStorage.setItem('pineapple-tours-booking-prompt', JSON.stringify({
      ...testData,
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Experience our intelligent booking prompt that appears after 30 seconds of user inactivity, 
            designed to capture user intent and streamline the booking process.
          </p>
        </div>
            ...
            {isActive && (
              <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="flex items-center text-sm text-blue-800">
                  ...
                  <span>
                    Stay inactive (don't click, scroll, or move your mouse) to see the popup appear.
                  </span>
                </div>
              </div>
            )}
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {promptData?.bookingDate ? format(promptData.bookingDate, 'MMM dd, yyyy') : 'Not selected'}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {promptData?.hasInteracted ? 'Interacted' : 'Not interacted'}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg">
                <div className="flex items-center text-sm text-green-800">
                  ...
                  <span className="ml-2">This data will be used to pre-fill search forms.</span>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Appears after 30 seconds of user inactivity to capture browsing intent
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Captures preferred travel dates with an intuitive date picker
                    </p>
                  </div>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-2">
                    Navigation to search page includes:
                  </p>
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li>• <code>travelers</code> - Number of travelers</li>
                    <li>• <code>checkIn</code> - Travel start date</li>
                    <li>• <code>checkOut</code> - Travel end date</li>
                    <li>• <code>sortBy</code> - Relevance sorting</li>
                  </ul>
                </div>
                ...
                <div>
                  <h4 className="font-medium mb-2">4. Search Integration</h4>
                  <p className="text-sm text-gray-600">
                    Search page reads URL parameters and booking prompt data to:
                  </p>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      The search API uses the travelers parameter to check real availability 
                      with the Rezdy API using the format: <code>ADULT:&#123;travelers&#125;</code>
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-gray-600 space-y-1 mt-2">
                      ...
                      <li>• Capacity for number of travelers</li>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Don't move your mouse, click, scroll, or press keys for 30 seconds
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">
                  Check that search page shows pre-filled data and filtered results
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <div className="mt-8 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-medium text-yellow-800 mb-1">Testing Notes</h4>
              <ul className="text-sm text-yellow-700 space-y-1">
                <li>• Use "Test Data Transfer" button to quickly test the search integration</li>
                <li>• The booking prompt is active on all pages of the website</li>
                <li>• If you've already interacted with it, open a new incognito window to see it again</li>
                <li>• Check the browser's Network tab to see API calls with travelers parameter</li>
              </ul>
            </div>
          </div>
        </div>
