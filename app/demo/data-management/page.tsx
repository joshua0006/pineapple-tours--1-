  ...
  const features = [
    {
      ...
      description:
        "Comprehensive validation schemas and automated data cleaning pipelines",
      icon: CheckCircle,
      color: "text-green-600",
      bgColor: "bg-green-100",
      stats: {
        "Validation Rules": "15+",
        "Data Quality Score": qualityMetrics
          ? `${Math.round(
              (qualityMetrics.completeness.products_with_descriptions /
    ...
    },
    {
      ...
      description:
        "Multi-dimensional product and customer segmentation with real-time filtering",
      icon: Filter,
      color: "text-blue-600",
      bgColor: "bg-blue-100",
      stats: {
    ...
    },
    {
      ...
      stats: {
        "Cache Hit Ratio": performanceMetrics
          ? `${Math.round(performanceMetrics.cache_hit_ratio * 100)}%`
          : "N/A",
        "Data Freshness": performanceMetrics
    ...
    },
    {
      ...
      description:
        "Real-time analytics dashboard with comprehensive insights and KPIs",
      icon: BarChart3,
  ...
  const demoSections = [
    {
      ...
      description:
        "AI-powered search with intelligent suggestions and advanced filtering",
      component: "search",
    },
    {
        ...
        <div className="container">
          <div className="text-center text-white">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-xl">
              Experience our comprehensive data management system featuring
              advanced validation, segmentation, caching, and analytics
              capabilities for optimal performance and insights.
            </p>
        ...
        <div className="container">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Comprehensive data management capabilities built for scale and
              performance
            </p>
          </div>
            ...
            <TabsContent value="search" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Try our advanced search with AI-powered suggestions and
            ...
            <TabsContent value="analytics" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Explore real-time data insights, quality metrics, and
