    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <div className="container py-12">
          <div className="mb-8">
            <h1 className="text-4xl font-bold mb-4">Description Display Components Demo</h1>
            <p className="text-lg text-muted-foreground">
              Showcasing enhanced description display with HTML content support, accessibility features, and responsive design.
            </p>
          </div>
          ...
          <div className="space-y-12">
            ...
            {/* Plain Text Display */}
            <section>
              <h2 className="text-2xl font-bold mb-6">Plain Text Content Display</h2>
              <div className="grid gap-6 lg:grid-cols-2">
                <DescriptionDisplay
            ...
            <section>
              <h2 className="text-2xl font-bold mb-6">Combined Description Types</h2>
              <DescriptionDisplay
            ...
            <section>
              <h2 className="text-2xl font-bold mb-6">Tour Information Display</h2>
              <div className="grid gap-6 lg:grid-cols-2">
                <TourInfoTable
              ...
              <Card>
                ...
                <CardContent>
                  <ul className="space-y-2 text-sm">
                    ...
                    <li>• <strong>Semantic HTML:</strong> Correct heading hierarchy and structure</li>
                    ...
                    <li>• <strong>Content sanitization:</strong> Safe HTML rendering with DOMPurify</li>
                    <li>• <strong>Responsive design:</strong> Optimized for all screen sizes</li>
                    <li>• <strong>High contrast:</strong> Sufficient color contrast ratios</li>
                    <li>• <strong>Text scaling:</strong> Content remains readable when text is enlarged</li>
                  </ul>
                </CardContent>
              </Card>
            </section>
