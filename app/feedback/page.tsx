...
export const metadata: Metadata = {
  ...
  description:
    "Share your tour experience with us. Your feedback helps us improve our services and helps other travelers choose the perfect tour.",
};
...
const testimonials = [
  {
    ...
    rating: 5,
    comment:
      "Absolutely fantastic experience! The buses were comfortable, the commentary was informative, and we could explore at our own pace. Highly recommend!",
    date: "2 weeks ago",
  },
  {
    name: "Michael Chen",
    ...
    rating: 5,
    comment:
      "Perfect day out! The guide was knowledgeable and friendly, and the scenery was breathtaking. Great value for money.",
    date: "1 month ago",
  },
  {
    name: "Emma Wilson",
    ...
    rating: 5,
    comment:
      "Amazing wine tour with beautiful vineyards and excellent tastings. The small group size made it feel very personal and special.",
    date: "3 weeks ago",
  },
];
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground font-text">
              Join thousands of satisfied customers who have shared their
              experiences
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                ...
                <div className="text-2xl font-bold text-brand-primary mb-1 font-primary">
                  {stat.number}
                </div>
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="location" className="font-secondary">
                      Your Location
                    </Label>
                    <Input id="location" placeholder="City, State" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="tour" className="font-secondary">
                      Tour Taken
                    </Label>
                    <Select>
                      <SelectTrigger>
                      ...
                      <SelectContent>
                        <SelectItem value="hop-on-hop-off">
                ...
                <div className="space-y-2">
                  <Label htmlFor="feedback" className="font-secondary">
                    Your Feedback *
                  </Label>
                  <Textarea
                    id="feedback"
                ...
                <div className="space-y-2">
                  <Label htmlFor="improvements" className="font-secondary">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="consent" className="text-sm font-text">
                    I consent to Pineapple Tours using my feedback for marketing
                    purposes and testimonials
                  </Label>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground font-text max-w-2xl mx-auto">
              See what our recent customers have to say about their tour
              experiences
            </p>
          </div>
      ...
      <section className="py-16 bg-brand-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90 font-text max-w-2xl mx-auto">
            Join thousands of satisfied customers and create your own
            unforgettable memories with Pineapple Tours.
          </p>
