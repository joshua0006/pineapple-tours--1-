...
import { MapPin, Clock, Users, Star, Bus, Route, Calendar, RefreshCw } from "lucide-react"
...
export default function HopOnHopOffPage() {
  ...
  const [hopOnHopOffProducts, setHopOnHopOffProducts] = useState<RezdyProduct[]>([])
  ...
  useEffect(() => {
    if (allProducts) {
      const filtered = allProducts.filter(product => 
        ...
        product.categories?.some(cat => cat.toLowerCase().includes('sightseeing'))
      )
  ...
  const routes = [
    {
      ...
      duration: "2 hours",
      stops: 12,
      highlights: ["Downtown District", "Historic Quarter", "Waterfront", "Shopping District"],
      price: "$25",
    ...
    },
    {
      ...
      duration: "3 hours",
      stops: 15,
      highlights: ["Beach Promenade", "Lighthouse Point", "Marina District", "Sunset Viewpoint"],
      price: "$35",
      image: "/api/placeholder/400/250"
    },
    {
      ...
      duration: "2.5 hours",
      stops: 10,
      highlights: ["Museums Quarter", "Art Galleries", "Cultural Center", "Heritage Sites"],
      price: "$30",
      image: "/api/placeholder/400/250"
    }
  ]
  ...
  const features = [
    {
      ...
      description: "Air-conditioned buses with panoramic windows for the best views"
    },
    {
      icon: <Route className="h-6 w-6" />,
      title: "Multiple Routes",
      description: "Choose from various themed routes covering all major attractions"
    },
    {
      icon: <Clock className="h-6 w-6" />,
      title: "Flexible Schedule",
      description: "Buses run every 15-20 minutes, hop on and off at your own pace"
    },
    {
      icon: <MapPin className="h-6 w-6" />,
      title: "Strategic Stops",
      description: "Conveniently located stops near all major attractions and landmarks"
    }
  ]
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto font-['Work_Sans']">
                Experience the ultimate flexibility in city exploration with our premium hop-on hop-off service
              </p>
            </div>
              ...
              {features.map((feature, index) => (
                <Card key={index} className="text-center hover:shadow-lg transition-shadow">
                  <CardHeader>
                    ...
                    <CardTitle className="font-['Barlow']">{feature.title}</CardTitle>
                  </CardHeader>
                  <CardContent>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto font-work-sans">
                {loading ? 'Loading available hop-on hop-off tours...' : 
                 hopOnHopOffProducts.length > 0 ? 
                 `Discover ${hopOnHopOffProducts.length} hop-on hop-off tour${hopOnHopOffProducts.length !== 1 ? 's' : ''} available` :
            ...
            {loading ? (
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {hopOnHopOffProducts.map((product) => (
                  <Card key={product.productCode} className="overflow-hidden hover:shadow-xl transition-shadow">
                    <div className="relative h-48">
                      <img 
                        src={product.images?.[0]?.itemUrl || "/api/placeholder/400/250"} 
                        alt={product.name}
                    ...
                    <CardHeader>
                      ...
                      <div className="flex items-center gap-4 text-sm text-muted-foreground">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          {product.quantityRequiredMin || 1}-{product.quantityRequiredMax || 20} guests
                        </div>
                      </div>
                    </CardHeader>
                    <CardContent>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {routes.map((route) => (
                  <Card key={route.id} className="overflow-hidden hover:shadow-xl transition-shadow">
                    ...
                    <CardHeader>
                      <CardTitle className="font-barlow text-brand-text">{route.name}</CardTitle>
                      <div className="flex items-center gap-4 text-sm text-muted-foreground">
                        <div className="flex items-center gap-1">
                    ...
                    <CardContent>
                      <div className="mb-4">
                        <h4 className="font-semibold mb-2 font-barlow text-brand-text">Highlights:</h4>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto font-['Work_Sans']">
                Getting started with our hop-on hop-off service is simple and convenient
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold mb-2 font-['Barlow']">Book Your Ticket</h3>
                <p className="text-gray-600 font-['Work_Sans']">
                  Choose your preferred route and purchase your ticket online or at any stop
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold mb-2 font-['Barlow']">Board the Bus</h3>
                <p className="text-gray-600 font-['Work_Sans']">
                  Show your ticket and hop on at any designated stop along the route
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold mb-2 font-['Barlow']">Explore & Enjoy</h3>
                <p className="text-gray-600 font-['Work_Sans']">
                  Get off at any attraction, explore at your pace, then hop back on the next bus
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-brand-primary text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 opacity-90 font-['Work_Sans']">
              Book your hop-on hop-off ticket today and discover the city like never before
            </p>
