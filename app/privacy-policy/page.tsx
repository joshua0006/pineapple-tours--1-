...
export const metadata: Metadata = {
  ...
  description:
    "Learn how we collect, use, and protect your personal information. Our commitment to privacy and data security for all tour bookings and interactions.",
};
...
const dataUse = [
  {
    ...
    description:
      "To provide and manage your tour bookings, communicate important information, and ensure safety",
    legal: "Contract Performance",
  },
  {
    purpose: "Customer Service",
    description:
      "To respond to inquiries, provide support, and resolve any issues with your booking or experience",
  ...
  },
  {
    ...
    description:
      "To ensure passenger safety, emergency contact, and comply with legal requirements",
    legal: "Legal Obligation",
  },
  {
    purpose: "Service Improvement",
    description:
      "To analyze usage patterns, improve our services, and develop new tour offerings",
    legal: "Legitimate Interest",
  },
];
...
const rights = [
  ...
  },
  {
    right: "Restriction",
    description:
      "Request limitation on how we process your personal information",
  },
  {
    right: "Objection",
    description:
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-muted-foreground font-text">
              ...
              by Pineapple Tours through our website, booking systems, and tour
              services. We are committed to transparency and protecting your
              privacy rights.
            </p>
          </div>
        </div>
                ...
                <CardContent>
                  <ul className="space-y-2">
                    {type.data.map((item, itemIndex) => (
                      <li
                        key={itemIndex}
                        className="flex items-start gap-2 text-sm font-text"
                      >
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground font-text max-w-2xl mx-auto">
              We use your personal information for specific purposes with
              ...
              <Card key={index}>
                <CardContent className="p-6">
                  <div className="flex justify-between items-start mb-3">
                    <h3 className="font-semibold text-brand-primary font-secondary">
                      {use.purpose}
                    </h3>
            ...
            <div className="prose prose-lg max-w-none font-text space-y-8">
              <div>
                ...
                <p>
                  ...
                  for the purposes outlined in this policy. Booking information
                  is typically retained for 7 years for tax and legal
                  compliance. Marketing preferences are retained until you
                  withdraw consent.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  ...
                  information with trusted service providers who assist with
                  tour operations, payment processing, and customer service. All
                  third parties are bound by confidentiality agreements and data
              ...
              <div>
                ...
                <p>
                  ...
                  browser settings. Essential cookies are necessary for booking
              ...
              <div>
                ...
                <p>
                  Your information may be processed in countries outside
                  Australia where our service providers operate. We ensure
              ...
              <div>
                ...
                <p>
                  ...
                  notification. Continued use of our services constitutes
      ...
      <section className="py-16 bg-brand-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90 font-text max-w-2xl mx-auto">
            ...
            Contact us if you have any questions or concerns about how we handle
            your information.
          </p>
