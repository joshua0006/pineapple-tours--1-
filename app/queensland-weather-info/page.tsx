...
export const metadata: Metadata = {
  ...
  description:
    "Complete guide to Queensland weather patterns, seasonal information, and packing tips to help you plan the perfect tour experience year-round.",
};
...
const seasons = [
  {
    ...
    humidity: "High",
    description:
      "Hot and humid with afternoon thunderstorms. Perfect for beach activities and water tours.",
    highlights: [
  ...
  },
  {
    ...
    humidity: "Moderate",
    description:
      "Mild temperatures with less humidity. Ideal weather for most outdoor activities.",
    highlights: [
  ...
  },
  {
    ...
    humidity: "Low",
    description:
      "Mild and dry with clear skies. Perfect weather for outdoor exploration.",
    highlights: [
  ...
  },
  {
    ...
    humidity: "Moderate",
    description:
      "Warming up with occasional showers. Beautiful wildflowers and perfect touring conditions.",
    highlights: [
...
const weatherTips = [
  {
    ...
    description:
      "Queensland sun is strong year-round. Always wear SPF 50+ sunscreen, hat, and sunglasses.",
  },
  {
    icon: CloudRain,
    title: "Rain Preparedness",
    description:
      "Summer storms can be sudden. Pack a light rain jacket or umbrella for afternoon tours.",
  },
  {
    icon: Thermometer,
    title: "Temperature Variations",
    description:
      "Coastal areas are milder than inland. Mountain regions can be 5-10°C cooler.",
  },
  {
    icon: Umbrella,
    title: "Humidity Awareness",
    description:
      "Summer humidity can be high. Choose breathable fabrics and stay hydrated.",
  },
];
            ...
            {regions.map((region, index) => (
              <Card key={index} className="hover:shadow-lg transition-shadow">
                ...
                <CardContent className="space-y-3">
                  <div>
                    <div className="text-sm font-semibold text-brand-primary font-secondary">
                      Best Time to Visit
                    </div>
                    <div className="text-sm text-muted-foreground font-text">
                      {region.bestTime}
      ...
      <section className="py-16 bg-brand-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90 font-text max-w-2xl mx-auto">
            Now that you know what to expect, it's time to book your perfect
            Queensland adventure. Our tours operate year-round with
