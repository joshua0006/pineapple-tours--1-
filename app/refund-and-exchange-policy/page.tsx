...
export const metadata: Metadata = {
  ...
  description:
    "Understand our refund and exchange policy. Learn about cancellation timeframes, refund processes, and exchange options for your tour bookings.",
};
...
const exchangeOptions = [
  ...
  },
  {
    ...
    conditions: [
      "Pay price difference if applicable",
      "Subject to availability",
...
const specialCircumstances = [
  {
    ...
    description:
      "Tours cancelled by us due to severe weather receive full refund or free rescheduling",
    icon: AlertCircle,
  },
  {
    title: "Medical Emergencies",
    description:
      "Medical certificates may qualify for full refund regardless of timing",
    icon: CheckCircle,
  },
  {
    title: "Force Majeure",
    description:
      "Events beyond our control (natural disasters, government restrictions) receive full refund",
    icon: AlertCircle,
  },
  {
    title: "Vehicle Breakdown",
    description:
      "Mechanical issues resulting in tour cancellation receive full refund or alternative tour",
    icon: CheckCircle,
  },
];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground font-text leading-relaxed">
              We understand that travel plans can change unexpectedly. Our
              refund and exchange policy is designed to be fair to both our
              customers and our business, ensuring we can continue to provide
              excellent service while accommodating your changing needs.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground font-text max-w-2xl mx-auto">
              Refund amounts depend on how much notice you give us before your
              tour departure
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {refundTiers.map((tier, index) => (
              <Card
                key={index}
                className={`text-center hover:shadow-lg transition-shadow border-l-4 ${
                  tier.color === "green"
                    ? "border-l-green-500"
                    : tier.color === "yellow"
                    ? "border-l-yellow-500"
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground font-text max-w-2xl mx-auto">
              Sometimes changing your booking is better than cancelling. Here
              are your options
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <Tabs defaultValue="refund-process" className="w-full">
              <TabsList className="grid w-full grid-cols-3">
                ...
                <TabsTrigger value="exchange-process">
                  Exchange Process
                </TabsTrigger>
                <TabsTrigger value="important-notes">
                  Important Notes
                </TabsTrigger>
              </TabsList>
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid md:grid-cols-4 gap-6">
                      <div className="text-center">
                        <div className="w-12 h-12 bg-brand-accent rounded-full flex items-center justify-center text-white text-xl font-bold mx-auto mb-3">
                          1
                        </div>
                        <h4 className="font-semibold mb-2 font-secondary">
                          Contact Us
                        ...
                        <p className="text-sm text-muted-foreground font-text">
                          Call or email with your booking reference
                        </p>
                      </div>
                      <div className="text-center">
                        <div className="w-12 h-12 bg-brand-accent rounded-full flex items-center justify-center text-white text-xl font-bold mx-auto mb-3">
                        ...
                        <p className="text-sm text-muted-foreground font-text">
                          Give reason for cancellation and any supporting
                          documents
                        </p>
                      </div>
                      <div className="text-center">
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-sm text-muted-foreground font-text">
                          Refund processed to original payment method in 5-10
                          days
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground font-text">
                            Call us at 0466 331 232 or email with your booking
                            reference and preferred changes
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground font-text">
                            We'll check availability for your preferred new date
                            or tour type
                          </p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-muted-foreground font-text">
                            Pay any price difference or processing fees, receive
                            new confirmation
                          </p>
                        </div>
                      </div>
                  ...
                  <CardContent className="space-y-4">
                    <ul className="space-y-3">
                      <li className="flex items-start gap-3 font-text">
                        ...
                        All refund requests must be made by the person who made
                      ...
                      <li className="flex items-start gap-3 font-text">
                        <div className="w-2 h-2 bg-brand-accent rounded-full mt-2 flex-shrink-0" />
                        Group bookings may have different terms - please check
                      ...
                      <li className="flex items-start gap-3 font-text">
                        <div className="w-2 h-2 bg-brand-accent rounded-full mt-2 flex-shrink-0" />
                        Refund timeframes are calculated from tour departure
                        time, not booking time
                      </li>
                    </ul>
                  </CardContent>
                </Card>
      ...
      <section className="py-16 bg-brand-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90 font-text max-w-2xl mx-auto">
            Our friendly team is here to help you with cancellations, refunds,
            and exchanges. Contact us as soon as possible for the best options.
          </p>
