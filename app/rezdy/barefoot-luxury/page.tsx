        ...
        <TabsContent value="products" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                All barefoot luxury products available in Rezdy, filtered by
                premium and exclusive keywords
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="raw-data" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Complete JSON data for all barefoot luxury products from Rezdy
                API
              </CardDescription>
            </CardHeader>
            <CardContent>
