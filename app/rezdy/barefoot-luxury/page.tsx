...
import { ArrowLeft, Sparkles, RefreshCw, Search, Grid, Code, DollarSign, Package, AlertCircle } from 'lucide-react';
...
export default function BarefootLuxuryRezdyPage() {
  ...
  const categoryConfig = getCategoryBySlug('barefoot-luxury');
    ...
    <div className="container mx-auto py-8 space-y-8">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Barefoot Luxury - Rezdy Data</h1>
            <p className="text-muted-foreground">
              Complete data analysis for barefoot luxury products from Rezdy API
            </p>
          </div>
        </div>
      </div>
      ...
      <Tabs defaultValue="products" className="space-y-6">
        ...
        <TabsContent value="products" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Barefoot Luxury Products</CardTitle>
              <CardDescription>
                All barefoot luxury products available in Rezdy, filtered by premium and exclusive keywords
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              {loading ? (
                ...
                viewMode === 'cards' ? (
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <h3 className="text-lg font-semibold">Barefoot Luxury JSON Data</h3>
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium mb-2">No luxury experiences found</h3>
                  <p className="text-muted-foreground">
                    {searchTerm 
                      ? 'Try adjusting your search terms.' 
                      : 'No barefoot luxury products available.'}
                  </p>
                </div>
              )}
            </CardContent>
        ...
        <TabsContent value="raw-data" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Raw Barefoot Luxury Data</CardTitle>
              <CardDescription>
                Complete JSON data for all barefoot luxury products from Rezdy API
              </CardDescription>
            </CardHeader>
            <CardContent>
