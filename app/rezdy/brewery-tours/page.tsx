...
import { ArrowLeft, Beer, RefreshCw, Search, Grid, Code, DollarSign, Package, AlertCircle } from 'lucide-react';
...
export default function BreweryToursRezdyPage() {
  ...
  const categoryConfig = getCategoryBySlug('brewery-tours');
    ...
    <div className="container mx-auto py-8 space-y-8">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Brewery Tours - Rezdy Data</h1>
            <p className="text-muted-foreground">
              Complete data analysis for brewery tour products from Rezdy API
            </p>
          </div>
        </div>
      </div>
      ...
      <Tabs defaultValue="products" className="space-y-6">
        ...
        <TabsContent value="products" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Brewery Tour Products</CardTitle>
              <CardDescription>
                All brewery tour products available in Rezdy, filtered by beer-related keywords and product types
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex flex-col gap-4 mb-6">
                <div className="flex items-center gap-4">
                  <div className="relative flex-1">
                    ...
                    <Input
                      placeholder="Search brewery tours..."
                      value={searchTerm}
              ...
              {loading ? (
                ...
                viewMode === 'cards' ? (
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <h3 className="text-lg font-semibold">Brewery Tours JSON Data</h3>
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium mb-2">No brewery tours found</h3>
                  <p className="text-muted-foreground">
                    {searchTerm 
                      ? 'Try adjusting your search terms.' 
                      : 'No brewery tour products available.'}
                  </p>
                </div>
              )}
            </CardContent>
        ...
        <TabsContent value="raw-data" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Raw Brewery Tours Data</CardTitle>
              <CardDescription>
                Complete JSON data for all brewery tour products from Rezdy API
              </CardDescription>
            </CardHeader>
            <CardContent>
