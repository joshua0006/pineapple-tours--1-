        ...
        <TabsContent value="products" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                All bus charter products available in Rezdy, filtered by charter
                and group transport keywords
              </CardDescription>
            </CardHeader>
            <CardContent>
