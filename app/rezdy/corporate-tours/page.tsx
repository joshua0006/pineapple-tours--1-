...
import { ArrowLeft, Building, RefreshCw, Search, Grid, Code, DollarSign, Package, AlertCircle } from 'lucide-react';
...
export default function CorporateToursRezdyPage() {
  ...
  const categoryConfig = getCategoryBySlug('corporate-tours');
    ...
    <div className="container mx-auto py-8 space-y-8">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Corporate Tours - Rezdy Data</h1>
            <p className="text-muted-foreground">
              Complete data analysis for corporate tour products from Rezdy API
            </p>
          </div>
        </div>
      </div>
      ...
      <Tabs defaultValue="products" className="space-y-6">
        ...
        <TabsContent value="products" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Corporate Tour Products</CardTitle>
              <CardDescription>
                All corporate tour products available in Rezdy, filtered by business and team building keywords
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex flex-col gap-4 mb-6">
                <div className="flex items-center gap-4">
                  <div className="relative flex-1">
                    ...
                    <Input
                      placeholder="Search corporate tours..."
                      value={searchTerm}
              ...
              {loading ? (
                ...
                viewMode === 'cards' ? (
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <h3 className="text-lg font-semibold">Corporate Tours JSON Data</h3>
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium mb-2">No corporate tours found</h3>
                  <p className="text-muted-foreground">
                    {searchTerm 
                      ? 'Try adjusting your search terms.' 
                      : 'No corporate tour products available.'}
                  </p>
                </div>
              )}
            </CardContent>
        ...
        <TabsContent value="raw-data" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Raw Corporate Tours Data</CardTitle>
              <CardDescription>
                Complete JSON data for all corporate tour products from Rezdy API
              </CardDescription>
            </CardHeader>
            <CardContent>
