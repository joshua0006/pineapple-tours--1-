...
export default function HopOnHopOffRezdyPage() {
    ...
    <div className="container mx-auto py-8 space-y-8">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Hop-On Hop-Off - Rezdy Data</h1>
      ...
      <Tabs defaultValue="products" className="space-y-6">
        ...
        <TabsContent value="products" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                All hop-on hop-off products available in Rezdy, filtered by sightseeing and transport keywords
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              {loading ? (
                ...
                viewMode === 'cards' ? (
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <h3 className="text-lg font-semibold">Hop-On Hop-Off JSON Data</h3>
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium mb-2">No hop-on hop-off tours found</h3>
                  <p className="text-muted-foreground">
                    {searchTerm 
                      ? 'Try adjusting your search terms.' 
                      : 'No hop-on hop-off products available.'}
                  </p>
                </div>
              )}
            </CardContent>
        ...
        <TabsContent value="raw-data" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle>Raw Hop-On Hop-Off Data</CardTitle>
              <CardDescription>
                Complete JSON data for all hop-on hop-off products from Rezdy API
              </CardDescription>
            </CardHeader>
            <CardContent>
