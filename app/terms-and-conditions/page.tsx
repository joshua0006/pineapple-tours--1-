...
export const metadata: Metadata = {
  ...
  description:
    "Read our terms and conditions for booking and participating in Pineapple Tours. Important information about bookings, cancellations, and tour policies.",
};
...
const importantNotes = [
  {
    ...
    description:
      "Children under 4 travel free when not occupying a seat. Some tours have minimum age restrictions.",
  },
  {
    title: "Health & Safety",
    description:
      "Passengers with medical conditions must inform us at booking. First aid is available on tours.",
  },
  {
    title: "Weather Policy",
    description:
      "Tours operate rain or shine. We provide weather updates and may modify itineraries for safety.",
  },
  {
    title: "Photography",
    description:
      "Photos may be taken during tours for promotional purposes. Please inform us if you prefer not to be photographed.",
  },
];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-muted-foreground font-text">
              These terms and conditions apply to all bookings made with
              Pineapple Tours. We reserve the right to update these terms at any
              time.
            </p>
          </div>
        </div>
                ...
                <CardContent>
                  <ul className="space-y-3">
                    {section.content.map((item, itemIndex) => (
                      <li
                        key={itemIndex}
                        className="flex items-start gap-3 font-text"
                      >
              ...
              {importantNotes.map((note, index) => (
                <Card key={index}>
                  <CardContent className="p-6">
                    <h3 className="font-semibold mb-2 text-brand-primary font-secondary">
                      {note.title}
                    </h3>
                    <p className="text-muted-foreground font-text">
                      {note.description}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none font-text">
              ...
              <p>
                In these terms and conditions, "Company" refers to Pineapple
                Tours, "Customer" refers to the person making the booking, and
                "Tour" refers to any service provided by the Company including
                but not limited to sightseeing tours, hop-on hop-off services,
                and charter services.
              </p>

              <h3 className="font-secondary">2. Booking Confirmation</h3>
              <p>
                A booking is only confirmed when payment has been received and a
                confirmation email has been sent. The Company reserves the right
                to decline any booking at its discretion. All bookings are
                subject to availability.
              </p>

              <h3 className="font-secondary">3. Tour Modifications</h3>
              <p>
                The Company reserves the right to modify tour itineraries,
                departure times, or routes due to weather conditions, road
                closures, mechanical issues, or other circumstances beyond our
                control. Where possible, alternative arrangements will be made
              ...
              <p>
                ...
                actions, strikes, or other force majeure events.
              </p>

              <h3 className="font-secondary">5. Privacy Policy</h3>
              <p>
                Personal information collected during booking is used solely for
                tour administration and customer service. We do not share
                personal information with third parties except as required by
                law or for tour operation purposes.
              </p>

              <h3 className="font-secondary">6. Governing Law</h3>
              <p>
                These terms and conditions are governed by the laws of
                Queensland, Australia. Any disputes will be resolved in the
      ...
      <section className="py-16 bg-brand-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90 font-text max-w-2xl mx-auto">
            By booking a tour with Pineapple Tours, you acknowledge that you
