...
import { MessageCircle, Clock, Star, Gift, MapPin, Phone, Mail, Facebook, Instagram, Youtube } from "lucide-react"
    ...
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-brand-secondary p-6 rounded-lg border border-brand-accent/20 shadow-sm">
          <h3 className="font-secondary text-lg font-normal text-brand-text mb-4">Get in Touch</h3>
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              <Phone className="h-5 w-5 text-brand-accent flex-shrink-0" />
              <a href="tel:0466331232" className="font-text text-base text-brand-accent hover:text-brand-accent/80 transition-colors">
                0466 331 232
              </a>
            </div>
            <div className="flex items-center gap-3">
              <Mail className="h-5 w-5 text-brand-accent flex-shrink-0" />
              <a href="mailto:bookings@pineappletours.com.au" className="font-text text-sm text-brand-accent hover:text-brand-accent/80 transition-colors break-all">
                bookings@pineappletours.com.au
              </a>
            </div>
            <div className="flex items-center gap-3">
              <Clock className="h-5 w-5 text-brand-accent flex-shrink-0" />
              <span className="font-text text-base text-brand-text/60">2hr response time</span>
            </div>
            <div className="flex items-center gap-3">
            <a href="tel:0466331232">
            <Button size="default" className="bg-brand-accent text-brand-secondary hover:bg-brand-accent/90 w-full font-text text-base font-normal">
        ...
        <div className="bg-brand-secondary p-6 rounded-lg border border-brand-accent/20 shadow-sm">
          ...
          <div className="space-y-3 mb-4">
            ...
            <a href="https://www.youtube.com/channel/UCAvl12VYyJ06rru5nQc0QbQ/featured" className="flex items-center gap-3 hover:bg-brand-accent/5 p-2 rounded-lg transition-colors">
              ...
              <span className="font-text text-base text-brand-text/70">Visit our channel on Youtube</span>
            </a>
          </div>
