import { RezdyBooking, RezdyBookingItem, RezdyParticipant, RezdyBookingExtra, RezdyCustomer } from '@/lib/types/rezdy'
 ...
 */
export function aggregateParticipants(guests: BookingFormData['guests']): RezdyParticipant[] {
 ...
 */
export function transformContactToCustomer(contact: BookingFormData['contact']): RezdyCustomer {
  return {
 ...
 */
export function getTotalParticipantCount(guests: BookingFormData['guests']): number {
